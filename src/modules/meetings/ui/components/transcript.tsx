...
const Transcript = ({
    ...
    return (
        <div
            className={"bg-white rounded-lg norder px-4 py-5 flex flex-col gap-y-4 w-full"}
        >
            <p
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <AvatarImage
                                                src={item.user.image ?? generateAvatarUri({ seed: item.user.name, variant: "bottsNeutral" })}
                                            />
                                        </Avatar>

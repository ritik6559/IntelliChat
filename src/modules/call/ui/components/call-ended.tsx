...
const CallEnded = () => {
    ...
    return (
        <div
            className={"flex flex-col items-center justify-center h-full bg-radial from-sidebar-accent to-sidebar"}
        >
            <div
                className={"py-4 px-8 flex flex-1 items-center justify-center"}
            >
                <div
                    className={"flex flex-col items-center justify-center gap-y-6 bg-background rounded-lg p-10 shadow-md"}
                >
                    <div
